...
func TestFindLatestVersion(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := Latest(scheme, tt.testData.Current, tt.testData.Tags, tt.testData.Major, tt.testData.Minor, tt.testData.Patch)
...
func TestSuffixMismatch(t *testing.T) {
	...
	result := Latest(Default(), test.Current, test.Tags, test.Major, test.Minor, test.Patch)
...
func TestSameTagFamily(t *testing.T) {
	...
	assert.False(t, SameFamily(1, 3))
	assert.False(t, SameFamily(3, 1))
}
...
func TestFindLatestPerLevelLoose(t *testing.T) {
	...
	patch, minor, major := LatestPerLevel(loose, "v2026.7.7.2", hermesTags)
